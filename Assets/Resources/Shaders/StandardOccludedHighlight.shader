Shader "Pinwheel/StandardOccludedHighlight" {
	Properties
	{
	...
	SubShader {
		UsePass "Pinwheel/OccludedHighlight/OCCLUDED"
//		UsePass "Standard/FORWARD"
	...
	CustomEditor "Pinwheel.ShaderCollection.Editor.StandardOccludedHighlightShaderGUI"
}
